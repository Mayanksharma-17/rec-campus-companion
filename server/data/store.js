...
const canteenData = {
  foodCourts: ["HUT CAFE", "REC CAFE", "6th Sense Garden", "Blackbuck Cafe"],
  rushGauge: "Low Rush",
  outletsMenu: {
    "HUT CAFE": [
      {
        ...
        items: [
          { name: "Crispy Samosa (2 pcs)", price: "₹25", rating: 4.8, availableAt: "HUT CAFE" },
          ...
          { name: "Vegetable Cutlet (2 pcs)", price: "₹35", rating: 4.7, availableAt: "HUT CAFE" }
        ]
      },
      {
        ...
        items: [
          ...
          { name: "Cold Coffee with Ice Cream", price: "₹60", rating: 4.8, availableAt: "HUT CAFE" },
          { name: "Chilled Rose Milk", price: "₹35", rating: 4.7, availableAt: "HUT CAFE" },
          { name: "Fresh Lemon Soda", price: "₹25", rating: 4.8, availableAt: "HUT CAFE" }
        ]
      },
      {
        category: "Main Meals & Fast Food",
        items: [
          ...
          { name: "Ghee Sambar Rice with Potato Chips", price: "₹60", rating: 4.8, availableAt: "HUT CAFE" }
        ]
      }
    ],
    "REC CAFE": [
      {
        category: "Cafe Snacks & Savories",
        items: [
          { name: "Cheese Chilli Toast", price: "₹45", rating: 4.7, availableAt: "REC CAFE" },
          { name: "Crispy Sweet Corn Roll", price: "₹35", rating: 4.6, availableAt: "REC CAFE" },
          { name: "Veg Cheese Burger", price: "₹55", rating: 4.8, availableAt: "REC CAFE" },
          { name: "Crispy French Fries", price: "₹50", rating: 4.7, availableAt: "REC CAFE" }
        ]
      },
      {
        category: "Hot Brews & Refreshers",
        items: [
          { name: "Hot Filter Coffee", price: "₹15", rating: 4.9, availableAt: "REC CAFE" },
          { name: "Special Ginger Tea", price: "₹12", rating: 4.8, availableAt: "REC CAFE" },
          { name: "Fresh Watermelon Juice", price: "₹40", rating: 4.7, availableAt: "REC CAFE" },
          { name: "Badam Milk (Hot / Cold)", price: "₹30", rating: 4.8, availableAt: "REC CAFE" }
        ]
      },
      {
        category: "Special Meals & Biryani",
        items: [
          ...
          { name: "Paneer Butter Masala + 2 Parottas", price: "₹95", rating: 4.8, availableAt: "REC CAFE" }
        ]
      }
    ],
    "6th Sense Garden": [
      {
        category: "Garden Mocktails & Smoothies",
        items: [
          { name: "Dragon Fruit & Berry Smoothie", price: "₹75", rating: 4.9, availableAt: "6th Sense Garden" },
          { name: "Iced Passion Fruit Mojito", price: "₹60", rating: 4.8, availableAt: "6th Sense Garden" },
          { name: "Green Apple & Mint Sparkler", price: "₹55", rating: 4.7, availableAt: "6th Sense Garden" },
          { name: "Avocado Honey Cream Shake", price: "₹80", rating: 4.9, availableAt: "6th Sense Garden" }
        ]
      },
      {
        category: "Artisanal Sandwiches & Wraps",
        items: [
          { name: "Grilled Mushroom & Cheese Panini", price: "₹70", rating: 4.8, availableAt: "6th Sense Garden" },
          { name: "Smoky Paneer Tikka Wrap", price: "₹65", rating: 4.9, availableAt: "6th Sense Garden" },
          { name: "Falafel & Garlic Hummus Roll", price: "₹75", rating: 4.6, availableAt: "6th Sense Garden" },
          { name: "BBQ Veg Triple Club Sandwich", price: "₹80", rating: 4.8, availableAt: "6th Sense Garden" }
        ]
      },
      {
        category: "Garden Fresh Bowls & Desserts",
        items: [
          { name: "Mediterranean Greek Salad Bowl", price: "₹90", rating: 4.7, availableAt: "6th Sense Garden" },
          { name: "Loaded Cheese Salsa Nachos", price: "₹85", rating: 4.9, availableAt: "6th Sense Garden" },
          { name: "Choco Lava Cake with Vanilla Gelato", price: "₹70", rating: 5.0, availableAt: "6th Sense Garden" }
        ]
      }
    ],
    "Blackbuck Cafe": [
      {
        category: "Barista Special Brews",
        items: [
          { name: "Caramel Hazelnut Cappuccino", price: "₹75", rating: 4.9, availableAt: "Blackbuck Cafe" },
          { name: "Iced Spanish Latte", price: "₹80", rating: 5.0, availableAt: "Blackbuck Cafe" },
          { name: "Classic Espresso Double Shot", price: "₹45", rating: 4.8, availableAt: "Blackbuck Cafe" },
          { name: "Japanese Matcha Green Tea Latte", price: "₹85", rating: 4.7, availableAt: "Blackbuck Cafe" }
        ]
      },
      {
        category: "Gourmet Bakery & Pastries",
        items: [
          { name: "French Butter Croissant", price: "₹50", rating: 4.8, availableAt: "Blackbuck Cafe" },
          { name: "Fudge Dark Chocolate Brownie", price: "₹60", rating: 4.9, availableAt: "Blackbuck Cafe" },
          { name: "New York Blueberry Cheesecake", price: "₹95", rating: 5.0, availableAt: "Blackbuck Cafe" },
          { name: "Herbed Garlic Breadsticks with Dip", price: "₹55", rating: 4.7, availableAt: "Blackbuck Cafe" }
        ]
      },
      {
        category: "Chef's Bistro Specials",
        items: [
          { name: "Truffle Oil Fries with Garlic Dip", price: "₹70", rating: 4.9, availableAt: "Blackbuck Cafe" },
          { name: "Spicy Arrabbiata Pasta Bowl", price: "₹110", rating: 4.8, availableAt: "Blackbuck Cafe" },
          { name: "Creamy Alfredo Penne Pasta", price: "₹120", rating: 4.9, availableAt: "Blackbuck Cafe" }
        ]
      }
    ]
  },
  menuCategories: [
    {
      ...
      items: [
        { name: "Crispy Samosa (2 pcs)", price: "₹25", rating: 4.8, availableAt: "HUT CAFE" },
        { name: "Cheese Chilli Toast", price: "₹45", rating: 4.7, availableAt: "REC CAFE" },
        { name: "Grilled Mushroom Panini", price: "₹70", rating: 4.8, availableAt: "6th Sense Garden" },
        { name: "French Butter Croissant", price: "₹50", rating: 4.8, availableAt: "Blackbuck Cafe" }
      ]
    }
  ],
  ratings: [
    ...
    {
      id: "cant-2",
      canteenName: "6th Sense Garden",
      dishName: "Dragon Fruit & Berry Smoothie",
      rating: 5,
      comment: "Best smoothie on campus at 6th Sense Garden! Outdoor seating vibe is amazing.",
      studentName: "Ananya S (CSE 3rd Year)",
      email: "ananya@rajalakshmi.edu.in",
      createdAt: "2026-08-15T15:20:00Z"
    },
    {
      id: "cant-3",
      canteenName: "Blackbuck Cafe",
      dishName: "Iced Spanish Latte & Blueberry Cheesecake",
      rating: 5,
      comment: "Blackbuck Cafe has legit authentic barista coffee and cheesecake. 10/10!",
...
// Official REC Transport Data (rectransport.com)
const transportData = {
  busesTotalCount: 130,
  helplines: [
    { name: "Transport Dept Office (Line 1)", phone: "044 6718 1069", role: "Main Helpdesk" },
    { name: "Transport Dept Office (Line 2)", phone: "044 6718 1040", role: "Main Helpdesk" },
    { name: "A. Natarajan", phone: "90252 24606", role: "Transport Co-ordinator" },
    { name: "L. Ramajayam", phone: "90252 24605", role: "Transport Co-ordinator" },
    { name: "P. Balasubramaniyan", phone: "95972 81620", role: "Transport Co-ordinator" },
    { name: "M. Venkatesan", phone: "75488 62533", role: "Transport Co-ordinator" },
    { name: "R. Kirubananthan", phone: "90252 24604", role: "Transport Co-ordinator" }
  ],
  officialEmail: "rectransport@rajalakshmi.edu.in",
  websiteUrl: "https://www.rectransport.com",
  trips: [
    {
      name: "Morning 1st Trip (To College)",
      time: "08:00 AM Arrival",
      busesCount: 130,
      scope: "All Routes & Stops",
      description: "Covers all 130 buses starting from starting points (06:15 AM - 07:00 AM) to REC Campus."
    },
    {
      name: "Morning 2nd Trip (To College)",
      time: "10:00 AM Arrival",
      busesCount: 14,
      scope: "Main Routes Only",
      description: "Serves students with 10:00 AM classes or lab sessions."
    },
    {
      name: "Afternoon Return Trip 1",
      time: "03:15 PM Departure",
      busesCount: 55,
      scope: "Main Routes",
      description: "Departs from REC Bus Bay after regular 3:15 PM class completion."
    },
    {
      name: "Evening Return Trip 2",
      time: "05:05 PM Departure",
      busesCount: 45,
      scope: "Main Routes",
      description: "Departs from REC Bus Bay after lab & special tutoring hours."
    }
  ],
  routes: [
    {
      ...
      routeNo: "Route 1",
      busNo: "TN-12-REC-001",
      startPoint: "Tambaram Sanatorium",
      departureTime: "06:40 AM",
      arrivalTime: "07:55 AM",
      viaStops: ["Tambaram Sanatorium", "MEPZ", "Chromepet", "Pallavaram", "Airport", "Guindy Kathipara", "Poonamallee Bypass"],
      driverName: "K. Mohan",
      driverPhone: "+91 94441 23456",
      liveStatus: "On Time",
      capacity: 55
    },
    {
      ...
      routeNo: "Route 12",
      busNo: "TN-12-REC-012",
      startPoint: "Koyambedu Metro Station",
      departureTime: "06:45 AM",
      arrivalTime: "07:50 AM",
      viaStops: ["Koyambedu Market", "Vadapalani Junction", "Ashok Nagar", "Guindy", "Porur Junction", "Poonamallee"],
      driverName: "S. Selvakumar",
      driverPhone: "+91 98402 34567",
      liveStatus: "On Time",
      capacity: 60
    },
    {
      ...
      routeNo: "Route 27",
      busNo: "TN-12-REC-027",
      startPoint: "Avadi Railway Station",
      departureTime: "06:35 AM",
      arrivalTime: "07:50 AM",
      viaStops: ["Avadi Checkpost", "Ambattur OT", "Thirumangalam", "Anna Nagar West", "Poonamallee Signal"],
      driverName: "P. Murugan",
      driverPhone: "+91 90252 11223",
      liveStatus: "On Time",
      capacity: 55
    },
    {
      ...
      routeNo: "Route 42",
      busNo: "TN-12-REC-042",
      startPoint: "Velachery Bus Terminus",
      departureTime: "06:30 AM",
      arrivalTime: "07:55 AM",
      viaStops: ["Velachery Bypass", "Madipakkam", "Keelkattalai", "Eachangadu", "Chromepet", "Pallavaram"],
      driverName: "V. Rajan",
      driverPhone: "+91 95972 33445",
      liveStatus: "On Time",
      capacity: 60
    },
    {
      ...
      routeNo: "Route 54",
      busNo: "TN-12-REC-054",
      startPoint: "T. Nagar Bus Terminus",
      departureTime: "06:40 AM",
      arrivalTime: "07:55 AM",
      viaStops: ["T. Nagar Bus Depot", "Saidapet Metro", "Guindy Kathipara", "Porur Toll Gate", "Saveetha Bus Stop"],
      driverName: "M. Ganesan",
      driverPhone: "+91 75488 44556",
      liveStatus: "On Time",
      capacity: 55
    },
    {
      ...
      routeNo: "Route 68",
      busNo: "TN-12-REC-068",
      startPoint: "Red Hills Bus Depot",
      departureTime: "06:20 AM",
      arrivalTime: "07:55 AM",
      viaStops: ["Red Hills", "Puzhal", "Kolathur", "Villivakkam", "Koyambedu", "Poonamallee"],
      driverName: "R. Elumalai",
      driverPhone: "+91 90252 55667",
      liveStatus: "On Time",
      capacity: 55
    },
    {
      ...
      routeNo: "Route 77",
      busNo: "TN-12-REC-077",
      startPoint: "Poonamallee Bus Terminus",
      departureTime: "07:15 AM",
      arrivalTime: "07:45 AM",
      viaStops: ["Poonamallee Depot", "Nazarethpet", "Saveetha Dental College", "Chembarambakkam Lake"],
      driverName: "D. Jayakumar",
      driverPhone: "+91 98403 66778",
      liveStatus: "On Time",
      capacity: 60
    },
    {
      ...
      routeNo: "Route 89",
      busNo: "TN-12-REC-089",
      startPoint: "Kanchipuram Bus Stand",
      departureTime: "06:30 AM",
      arrivalTime: "07:50 AM",
      viaStops: ["Orikkai", "Kanchipuram Collectorate", "White Gate", "Sunguvarchatram", "Sriperumbudur"],
      driverName: "K. Baskar",
      driverPhone: "+91 94442 77889",
      liveStatus: "On Time",
      capacity: 55
    }
  ]
